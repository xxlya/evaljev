...
- `docs/index.html` — the **console** for the example support assistant: a masthead
  sentence saying what the window looks like, a ribbon of one tick per request, three
  inline counts that double as filters, the workflow as a line of named steps with the
